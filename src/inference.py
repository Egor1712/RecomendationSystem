...
class HmRecommender:
    def __init__(self, model_path='./models/lightfm_best.pkl',
        ...
        # Заглушки для фичей (в реальности их нужно передавать в predict)
        # LightFM требует передачи user_features и item_features. Для простоты API будет
        # загружать эти фичи при старте.
    ...
    def recommend(self, user_id, top_k=12, exclude_purchased=True):
        """Возвращает список (article_id, score) для пользователя."""
